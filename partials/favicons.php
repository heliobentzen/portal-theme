<link rel="icon" href="<?php echo esc_url(get_template_directory_uri()); ?>/favicons/favicon.ico">
<link rel="icon" type="image/svg+xml" href="<?php echo esc_url(get_template_directory_uri()); ?>/favicons/favicon.svg">
...
<link rel="manifest" href="<?php echo esc_url(get_template_directory_uri()); ?>/favicons/ifpe.webmanifest">
