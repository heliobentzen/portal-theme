<div class="lista-noticias">
    ...
    <?php
        if (is_home()) {
            ...
            echo single_cat_title(__('Not&iacute;cias da categoria&nbsp;', 'ifpe-portal-theme'), false);
        } elseif (is_tag()) {
            echo single_tag_title(__('Not&iacute;cias com a tag&nbsp;', 'ifpe-portal-theme'), false);
        } elseif (is_tax('escopo')) {
            echo single_term_title('Not&iacute;cias para ', false);
        } else {
            echo __('Not&iacute;cias', 'ifpe-portal-theme');
        }
    ?>
    </h2>
