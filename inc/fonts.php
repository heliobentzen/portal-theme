...
?>
    ...
    <link rel="preload" href="<?php echo esc_url( $fonts_file ); ?>" as="style"/>
    <link rel="stylesheet" href="<?php echo esc_url( $fonts_file ); ?>" media="print" onload="this.media='all'"/>
    <noscript>
        <link rel="stylesheet" href="<?php echo esc_url( $fonts_file ); ?>"/>
    </noscript>
<?php
}, 1);
