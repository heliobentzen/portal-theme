...
function portal_breadcrumb() {
    ...
    if (!is_front_page() || is_paged()) {
		...
		echo '<li>'.__('Voc&ecirc; est&aacute; em:&nbsp;', 'ifpe-portal-theme').'</li>';
        ...
        if (is_home()) {
            ...
            if (is_tax('curso_modalidade') && !isset($_POST['curso_modalidade'])) {
                echo '<li class="breadcrumb-item"><a href="' . get_post_type_archive_link( 'curso' ) . '">' . __('Cursos', 'ifpe-portal-theme') . '</a></li>';
                ...
                echo '<li class="breadcrumb-item"><a href="' . get_post_type_archive_link( 'concurso' ) . '">' . __('Concursos', 'ifpe-portal-theme') . '</a></li>';
                echo $before . single_term_title('', false) . $after;
            } elseif (is_tax('documento_type') && !isset($_POST['documento_type'])) {
                echo '<li class="breadcrumb-item"><a href="' . get_post_type_archive_link( 'documento' ) . '">' . __('Documentos', 'ifpe-portal-theme') . '</a></li>';
                echo $before . single_term_title('', false) . $after;
            } elseif (is_tax('documento_origin') && !isset($_POST['documento_origin'])) {
                echo '<li class="breadcrumb-item"><a href="' . get_post_type_archive_link( 'documento' ) . '">' . __('Documentos', 'ifpe-portal-theme') . '</a></li>';
                echo $before . single_term_title('', false) . $after;
            } elseif (is_tax('edital_category') && !isset($_POST['edital_category'])) {
                echo '<li class="breadcrumb-item"><a href="' . get_post_type_archive_link( 'edital' ) . '">' . __('Editais', 'ifpe-portal-theme') . '</a></li>';
                echo $before . single_term_title('', false) . $after;
